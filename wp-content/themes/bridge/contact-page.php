				...
				<div class="contact_detail">
					<?php if($show_section == "yes") { ?>
						<div class="contact_section<?php echo $map_form_section_position_class; ?>">
							...
							echo $qode_options_proya['contact_section_above_form_title'];  } else { ?><?php _e('Get in touch', 'qode'); ?><?php } ?></h2>
						...
						<div class="column2">
							<div class="column_inner">
								<div class="contact_form">
									<h5><?php if($qode_options_proya['contact_heading_above'] != "") { echo $qode_options_proya['contact_heading_above'];  } else { ?><?php _e('Contact Me', 'qode'); ?><?php } ?></h5>
									<form id="contact-form" method="post" action="">
										...
										<span class="submit_button_contact">
											<input class="qbutton contact_form_button" type="submit" value="<?php _e('Contact Me', 'qode'); ?>" />
										</span>
									</form>	
								</div>
