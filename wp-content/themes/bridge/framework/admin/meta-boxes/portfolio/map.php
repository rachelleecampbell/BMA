...
$qodeFramework->qodeMetaBoxes->addMetaBox("porfolio_title",$qodeTitle);
	...
	$qode_show_page_title = new QodeMetaField("yesempty","qode_show-page-title","","Don't Show Title Area","Enable this option to turn off page title area", array(), array("dependence" => true, "dependence_hide_on_yes" => "#qodef_qode_page_title_area_container, #qodef-meta-box-portfolio_title_animations", "dependence_show_on_yes" => ""));
	...
	$qode_show_page_title_text = new QodeMetaField("yesempty","qode_show-page-title-text","","Don't Show Title Text","Enable this option to hide the title text", array(), array("dependence" => true, "dependence_hide_on_yes" => "#qodef_qode_title_text_container, #qodef_animation_page_page_title_container", "dependence_show_on_yes" => ""));
