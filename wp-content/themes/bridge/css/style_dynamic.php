...
if(is_array($footer_top_padding_styles) && count($footer_top_padding_styles)) { ?>
    .footer_top { <?php echo implode(';', $footer_top_padding_styles); ?> }
<?php } ?>
...
<?php
	...
	.footer_top,
	.footer_top p,
	.footer_top span:not(.q_social_icon_holder):not(.fa-stack):not(.qode_icon_shortcode),
	.footer_top li,
	.footer_top .textwidget,
	.footer_top .widget_recent_entries>ul>li>span{
...
<?php if($blog_masonry_title_styles !== ""){ ?>
	...
	.blog_holder.masonry_full_width h5,
	.blog_holder.masonry h5 a,
	.blog_holder.masonry_full_width h5 a
	{
...
<?php if(isset($qode_options_proya['blog_masonry_title_hover_color']) && $qode_options_proya['blog_masonry_title_hover_color'] !== '') { ?>
	...
	.blog_holder.masonry_full_width h5 a:hover
	{
