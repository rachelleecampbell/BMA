...
if($row_type == 'row') {
	$output .= '<div '.$row_id.' '.$anchor_id.' '.$menu_title.' '.$menu_icon.' class="' . $css_class . $css_class_type . $css_class_in_content_menu . $css_class_video . $use_row_as_box_class  . $full_screen_section_class .'"';
    ...
    $output .='<section '.$row_id.' '.$anchor_id.' '.$menu_title.' '.$menu_icon.' data-speed="'. $parallax_speed .'" class="parallax_section_holder '.$el_class.' '.$css_class_in_content_menu.'" style = "';
